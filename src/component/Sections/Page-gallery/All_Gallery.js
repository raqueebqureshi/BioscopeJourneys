...
const All_Gallery = ({ initialValues }) => {
  return (
    <section className="">
      {initialValues &&
                  ...
                  data.product.map((product_data, index) => {
                    return (
                      <div className="relative group" key={index}>
                        <div className="relative overflow-hidden before:pt-full rounded-xl before:block after:w-full after:transition-all after:h-full after:absolute after:top-0 after:left-0 after:bg-dark-900 after:opacity-20 group-hover:after:opacity-40">
                          <Image
