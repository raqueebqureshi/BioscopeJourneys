          ...
          return (
            <div className="container" key={index}>
              <div className="text-center mb-8 md:mb-14">
                ...
                <p className="max-w-[950px] mx-auto">{"With our extensive knowledge and ground support, we assure that your journey will be seamless and unforgettable. Our thoughtfully designed itineraries venture beyond the usual tourist paths, enabling you to discover the country`&rsquo;`s diverse heritage, stunning landmarks, and breath-taking landscapes. With Bioscope Journeys India, you won`&rsquo;`t just visit India—you`&rsquo;`ll experience its magic, leaving you with stories and impressions that resonate long after you return home."}</p>
                <p className="max-w-[950px] mx-auto font-bold">{"Let`&rsquo;`s embark on an unforgettable adventure together!"}</p>
              </div>
