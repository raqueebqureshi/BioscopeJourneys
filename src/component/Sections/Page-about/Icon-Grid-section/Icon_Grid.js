...
const Icon_Grid = ({ initialValues }) => {
  ...
  <p className="font-bold text-center text-3xl ">Why Choose Us?</p><br/>
  ...
  <br/><br/>
  <p className="font-bold text-center text-3xl ">Join us on your next adventure</p><br/>
  ...
  <p className="font-bold text-center text-3xl ">About the Name and Logo</p><br/>
