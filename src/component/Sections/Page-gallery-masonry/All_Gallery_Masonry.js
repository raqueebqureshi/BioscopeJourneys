                      ...
                      <div className="relative group" key={index}>
                        <div className="relative overflow-hidden rounded-xl">
                          <Link
                            ...
                            className="after:w-full after:transition-all after:h-full after:absolute after:top-0 after:left-0 after:bg-dark-900 after:opacity-20 group-hover:after:opacity-40 block"
                          >
                            <img
                              src={product_data.image}
                              alt={product_data.alt}
                              className="transition-all group-hover:scale-105 w-full duration-300"
                            />
                          </Link>
                        </div>
                      </div>
