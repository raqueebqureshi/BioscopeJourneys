...
import { All_Tour_List } from "@/component/Sections/Page-tour-list";
...
export default function Destination() {
  ...
  const { data: tour_list_product_data } = useFetchData(
    "json/data/tour_list_product.json"
  );
  ...
  return (
    <>
      ...
      <All_Tour_List
        initialValues={tour_list_product_data}
